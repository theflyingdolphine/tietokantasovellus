...
- Käyttäjä on joko "user" tai "admin".
 
- Sovelluksessa on 2 vakio peliä "game1" ja "game2" missä tehtävät eivät muutu.

- Peli 3 ("game3") arpoo  kysymyksen tietokannasta.

- Pelin jälkeen käyttäjä saa palautteen ja tilasto lisätään tietokantaan.
